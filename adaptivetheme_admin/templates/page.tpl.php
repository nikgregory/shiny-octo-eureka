...
<div id="page" class="container">
  ...
  <div id="main-content-header">
    ...
    <?php if (!$in_overlay): // hide in overlay ?>
      ...
      <?php if ($primary_local_tasks): ?>
        <nav id="primary-tasks"><ul class="tabs primary"><?php print render($primary_local_tasks); ?></ul><nav>
      <?php endif; ?>
    ...
    <div id="columns"><div class="columns-inner clearfix">
      <div id="content-column"><div class="content-inner">
        ...
        <?php if ($secondary_local_tasks): ?>
          <nav id="secondary-tasks"><ul class="tabs secondary"><?php print render($secondary_local_tasks); ?></ul></nav>
        <?php endif; ?>
  ...
  <?php if (!$in_overlay): // hide in overlay ?>
    ...
    <?php if ($page['footer'] || $secondary_navigation): ?>
