...
// Enable LiveReload
$form['devel']['live_reload'] = array(
  '#type' => 'fieldset',
  '#title' => t('Live Reload'),
);

$form['devel']['live_reload']['settings_enable_live_reload'] = array(
  '#type' => 'checkbox',
  '#title' => t('LiveReload'),
...
$form['devel']['live_reload']['settings_live_reload_port'] = array(
  '#type' => 'textfield',
  '#size' => 5,
  '#maxlength' => 5,
  ...
  '#states' => array(
    'visible' => array('input[name="settings_enable_live_reload"]' => array('checked' => TRUE)),
  ),
);
